        ...
        <h3 class="mb-5">
            <form id="testquestionform">
                <div class="form-group">
                    <input type="question" class="form-control form-control-lg w-75 mx-auto my-3" id="questionOutput" placeholder="">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#testquestionform").submit(function(event) {
                ...
                $("#showans").html("<span id=\"loading\">⌛</span> This won't take long...");
                $("#displaymod").modal();
